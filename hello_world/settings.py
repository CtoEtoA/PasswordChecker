...
RENDER_HOST = "passwordchecker-rgv3.onrender.com"
ALLOWED_HOSTS = config("ALLOWED_HOSTS", default=RENDER_HOST).split(",")

# CSRF trusted origins for Render and Codespaces
CSRF_TRUSTED_ORIGINS = [
    f"https://{RENDER_HOST}",  # Render production
]

# Add Codespaces trusted origin if running in Codespaces
